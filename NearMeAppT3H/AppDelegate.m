...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageNamed:@"bg_navbar.png"] forBarMetrics:UIBarMetricsDefault];
    ...
    NSString *bundleNewLocation = [[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"NewLocation.txt"];
    if (![fileManger contentsAtPath:documentPath]) {
        [fileManger copyItemAtPath:bundle toPath:documentPath error:nil];
        
    }
    if (![fileManger contentsAtPath:NEWLOCATION]) {
        [fileManger copyItemAtPath:bundleNewLocation toPath:NEWLOCATION error:nil];
    }
